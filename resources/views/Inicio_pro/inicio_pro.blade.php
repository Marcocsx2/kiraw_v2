        ...
        <div class="col-lg-3 col-md-6 mb-3">
            ...
            <div class="card">
                ...
                <div class="view overlay aqua-gradient ">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <br>
                            <div class="">
                                <img class="card-img-top rounded-circle z-depth-1" src="{{ URL::asset('assets/Imagenes/Productos/limacafe.png') }}" alt="Card image cap">
                            </div>
                            <br>
                        </div>
                        <div class="col-3"></div>
                ...
                <div class="card-body ">
                    ...
                    <h2 class="text-center">Coffe Peru SAC</h2>
